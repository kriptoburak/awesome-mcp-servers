...
- **[Xquik](https://github.com/Xquik-dev/x-twitter-scraper)** - Remote MCP server and REST API for X (Twitter) data workflows: search, extract posts, monitor accounts, run giveaways, compose posts, and deliver webhooks.
