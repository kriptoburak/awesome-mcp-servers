...
- **[Xquik](https://github.com/Xquik-dev/x-twitter-scraper)** - X/Twitter MCP server and REST API for tweet search, profile tweets, follower export, media downloads, posting tweets, replies, DMs, and webhooks.
